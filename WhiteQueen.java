	...
	public void calculateAlpha(Gamepiece[][] board) {
		...
		do {
			...
			if(!U) {
				if(board[up][x].val() != 0) {
					U = true;
				} else if(((Blank)board[up][x]).bq < 127) {
			...
			if(!D) {
				if(board[down][x].val() != 0) {
					D = true;
				} else if(((Blank)board[down][x]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
			...
			if(!L) {
				if(board[y][left].val() != 0) {
					L = true;
				} else if(((Blank)board[y][left]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
			...
			if(!R) {
				if(board[y][right].val() != 0) {
					R = true;
				} else if(((Blank)board[y][right]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
			...
			if(!UR) {
				if(board[up][right].val() != 0) {
					UR = true;
				} else if(((Blank)board[up][right]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
			...
			if(!UL) {
				if(board[up][left].val() != 0) {
					UL = true;
				} else if(((Blank)board[up][left]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
			...
			if(!DL) {
				if(board[down][left].val() != 0) {
					DL = true;
				} else if(((Blank)board[down][left]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
			...
			if(!DR) {
				if(board[down][right].val() != 0) {
					DR = true;
				} else if(((Blank)board[down][right]).bq < 127) {
					// stepSize serves as this queen's King Move Distance to this square
